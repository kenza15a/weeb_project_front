const FirstSectionTitle = () => {
  return (
    <h2 className="flex flex-row gap-x-4 flex-wrap text-4xl md:text-5xl text-heading max-w-[70%] lg:max-w-[55%]">
...
const SecondSectionTitle = () => {
  return (
    <h2 className="flex flex-row md:gap-x-4 flex-wrap text-4xl md:text-5xl text-heading ">
